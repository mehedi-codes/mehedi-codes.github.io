export default function Home() {
  return (
    <div className="bg-gradient-to-br from-black via-slate-950 to-indigo-950">
      <div className="w-screen h-screen flex flex-col items-center justify-center relative">
        ...
        <div className="relative z-10 text-center px-4">
          ...
          <div className="subtitle h-px w-32 sm:w-48 bg-gradient-to-r from-transparent via-indigo-400 to-transparent mx-auto mb-6"></div>
