...
const Footer = () => {
  return (
    <section className="bg-[#0E0E0C] text-white">
      <MaxWidthWrapper>
        <footer className="text-center py-3 text-xl font-grotesk flex items-center justify-between">
          <p>
