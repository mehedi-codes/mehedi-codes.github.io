...
const en = {
  ...
  "notfound.message": "The page you're looking for doesn't exist or has moved. Some things drift - let's get you back on track.",
...
const bn: Record<TranslationKey, string> = {
  ...
  "notfound.message": "আপনি যে পৃষ্ঠাটি খুঁজছেন তা বিদ্যমান নেই বা সরিয়ে দেওয়া হয়েছে। কিছু অস্থির হতেই পারে - চলুন, আপনাকে আবার ঠিক জায়গায় নিয়ে যাই।",
